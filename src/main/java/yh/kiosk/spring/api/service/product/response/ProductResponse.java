package yh.kiosk.spring.api.service.product.response;
...
public class ProductResponse {
	...
	@Builder
	public ProductResponse(Long id, String productNumber, ProductType type, ProductSellingStatus sellingType,
		String name,
		int price) {
		this.id = id;
